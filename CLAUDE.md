...
Note that build may take several minutes to complete. Make sure to wait for the build to finish completely before proceeding to the next task.

**Important Notes:**
- The build process may take several minutes to complete
- Always wait for the build to finish completely before proceeding to the next task
- Do not proceed with further work if the build fails
